...
const API_KEY = process.env.GOOGLE_AI_API_KEY || 'AIzaSyBeMry95mVOeqIWexQQbxkTq9fTl3ph5Q0';
const PROJECT_NUMBER = process.env.GOOGLE_PROJECT_NUMBER || '892045469913';
