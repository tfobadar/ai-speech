...
export default function TextToSpeechGenerator() {
    ...
    useEffect(() => {
        const loadPdfjs = async () => {
            try {
                ...
                // Use a simple approach without worker for better compatibility
                pdfjsLib.GlobalWorkerOptions.workerSrc = 'data:application/javascript;base64,';

                setPdfjs(pdfjsLib);
                console.log('PDF.js loaded successfully (simplified mode)');
            } catch (error) {
    ...
    const extractTextFromPDF = async (file: File): Promise<string> => {
        ...
        try {
            ...
            if (!trimmedText) {
                throw new Error('No text found in the PDF. The PDF might be image-based or encrypted.');
            }
    ...
    const extractTextFromDOCX = async (file: File): Promise<string> => {
        ...
        throw new Error('DOCX support requires additional setup. Please convert to PDF or TXT for now.');
    };
        ...
        <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                    <h1 className="text-3xl font-bold text-gray-800 mb-6">Enhanced Text to Speech</h1>
            ...
            <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-700">PDF File Upload</span>
                    </div>
                    <div className="flex items-center space-x-2">
                        <svg className="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
